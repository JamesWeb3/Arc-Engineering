            ...
            {trades.map((trade, index) => (
              <TableRow key={index}>
                  ...
                  >
                    {!editTradeIds.includes(index.toString()) ? (
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleInputChange(e, key as keyof Trade)
                        }
                        onKeyPress={(e) =>
                          handleKeyPress(e, index.toString(), key)
                        }
                ...
                <TableCell className="text-background">
                  {editTradeIds.includes(index.toString()) ? (
                    <button
                      onClick={() => handleSave(index.toString(), 'invoice')}
                    >
                      Save
                    </button>
                  ) : (
                    <button onClick={() => handleEditClick(index.toString())}>
                      Edit
                    </button>
                  )}
                </TableCell>
